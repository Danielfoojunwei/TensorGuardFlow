...
class TestConvolutionDetector:
    ...
    def test_default_kernels_exist(self):
        ...
        from tensorguard.rtpl.attack.convolution_detector import ConvolutionDetector
...
class TestCorrelationDetector:
    ...
    def test_correlation_coefficient_range(self):
        ...
        from tensorguard.rtpl.attack.correlation_detector import CorrelationDetector
...
class TestFeatureExtractor:
    ...
    def test_feature_vector_length(self):
        ...
        from tensorguard.rtpl.attack.feature_extractor import ActionFeatures
...
class TestPaddingDefense:
    ...
    def test_padding_increases_size(self):
        ...
        from tensorguard.rtpl.defense.padding import PaddingOnly, PaddingConfig
    ...
    def test_padding_roundtrip(self):
        ...
        from tensorguard.rtpl.defense.padding import PaddingOnly
    ...
    def test_overhead_curve(self):
        ...
        packets = [{"s": 150} for _ in range(100)]
        curve = PaddingOnly.overhead_curve(packets, [100, 500, 1000])
        
        # Larger buckets = more overhead
...
class TestFRONTDefense:
    ...
    def test_defend_adds_packets(self):
        ...
        from tensorguard.rtpl.defense.front import FRONT
...
class TestWTFPADDefense:
    ...
    def test_histogram_sampling(self):
        ...
        from tensorguard.rtpl.defense.wtf_pad import IATHistogram
    ...
    def test_simulate_defense(self):
        ...
        from tensorguard.rtpl.defense.wtf_pad import WTFPAD
        
        defense = WTFPAD()
        
        packets = [
            {"t": 0.0, "s": 100, "d": 1},
            {"t": 0.5, "s": 150, "d": -1},  # Large gap
            {"t": 0.6, "s": 120, "d": 1},
        ]
        
        defended = defense.simulate_defense(packets, simulate_time=True)
        
        # Should add dummies to fill gaps
        assert len(defended) >= len(packets)
...
class TestDeterminismGuard:
    ...
    def test_passes_within_bounds(self):
        ...
        from tensorguard.rtpl.safety.determinism_guard import DeterminismGuard
    ...
    def test_profiles_exist(self):
        ...
        from tensorguard.rtpl.safety.determinism_guard import PROFILES
...
class TestSyntheticDataset:
    ...
    def test_generate_action_trace(self):
        ...
        from tensorguard.rtpl.data.synthetic import SyntheticDatasetGenerator
