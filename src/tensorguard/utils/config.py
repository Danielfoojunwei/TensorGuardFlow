...
class TensorGuardSettings(BaseSettings):
    ...
    PRODUCTION_MODE: bool = Field(default=False, description="Enable production enforcement mode")
    ENABLE_EXPERIMENTAL_CRYPTO: bool = Field(default=False, description="Allow experimental N2HE in production (requires explicit opt-in)")
